...
class EventType(StrEnum):
    ...
    STRATEGY_READINESS_CHANGED = "STRATEGY_READINESS_CHANGED"
    ...
    LEG_TYPE_UNKNOWN = "LEG_TYPE_UNKNOWN"
    LEG_TYPE_CONTRADICTED = "LEG_TYPE_CONTRADICTED"
    LEG_STATE_DIVERGED = "LEG_STATE_DIVERGED"
