...
- [x] 2.2 Market-hours smoke: band subscriptions appear; `option_bars` rows land with `source=live`
  and correct resolved `expiry_date`/`strike`/`trading_symbol`
  (skipped — needs live Dhan creds + open market hours; archived with warning)
- [x] 2.3 `openspec archive 2026-06-12-options-warehouse-feed`
