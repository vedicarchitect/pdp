# order-preflight Specification

## Purpose
Pre-trade safety checks run by `OrderRouter` before any live order is dispatched to the broker: lot/freeze validation, Dhan margin check with basket routing, charge estimation, and credential gating.
