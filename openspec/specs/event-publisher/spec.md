# event-publisher Specification

## Purpose
Live event publisher: continuously monitors held positions and the underlying market,
runs a library of detectors over the universal indicator engine and option analytics,
and publishes de-duplicated real-time events to an in-app feed and browser/desktop push.
