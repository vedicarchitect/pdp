# options-analytics-tools Specification

## Purpose
Frontend analytics page providing three options analytics panels (Max Pain, GEX, OI Heatmap) with auto-refresh and paper-mode graceful degradation.
