# positional-monitor Specification

## Purpose
Multi-leg F&O positional book monitor: strategy-grouped position view with aggregate Greeks, expiry proximity alerts, per-leg rollover cost estimator, EOD P&L snapshots, and a daily P&L sparkline chart.
