...
export function KillSwitchButton() {
  ...
  return (
    <div className="relative">
      ...
      {/* Confirmation modal */}
      {uiState === 'confirming' && (
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-50 transition-opacity" role="dialog" aria-modal aria-labelledby="kill-switch-title" aria-describedby="kill-switch-desc">
          <div className="glass-panel border-bearish/50 rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl shadow-bearish/10 transform scale-100 transition-transform">
            <h2 id="kill-switch-title" className="text-lg font-bold text-bearish mb-2"><span aria-hidden="true">⚠</span> Confirm Kill Switch</h2>
            <p id="kill-switch-desc" className="text-text-muted text-sm mb-6 leading-relaxed">
